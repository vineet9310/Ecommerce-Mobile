...
// import Sidebar from '../shared/Sidebar'; // Remove this import
...
const AdminDashboard = () => {
  ...
  return (
    // Remove the surrounding Flex and Box with ml="250px"
    // The AdminLayout component now handles this structure
    <Box> {/* Use a simple Box or Fragment */}
